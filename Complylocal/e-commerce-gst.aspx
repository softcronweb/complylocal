...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section
        ...
        <div class="order-1 sm:order-2 flex flex-col lg:w-1/2  lg:pl-8">
            <h2 class="text-3xl font-bold mb-3 text-[#1c5a88] ">E-Commerce GST</h2>
    ...
    <div class="bg-[#fafafa] ">
        <div class="bg-[#E5F1E3] text-[#1c5a88] px-5 sm:px-20 py-20 rounded-t-[50px] sm:rounded-t-[100px] min-h-screen flex justify-center items-center  ">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div>
                    <h3 class="text-3xl font-semibold">E-Commerce GST
                    </h3>
                </div>
    ...
    <div class="bg-[#E5F1E3]">
        <section
            ...
            <div class="flex flex-col lg:w-1/2 lg:order-2 items-start">
                <h2 class="text-3xl  font-bold text-gray-900 mb-6 leading-tight">E-Commerce GST
                </h2>
                <p class="text-gray-600 text-lg mb-6">
                    So, if you want to unscrew the Goods and Services Tax (GST) compliance knot for your e-commerce business, head over to ComplyLocal – Your Saviour. We realize the pain points of online businesses when it comes to GST compliance and that is why at ComplyLocal, we are changing the way you think about managing your business. For e-commerce, we present end-to-end solutions custom-built to handle GST registration and filing as well as make compliance easier under our breakneck cloud applicability. Our expertise and user-friendly tools can help you streamline GST and minimize the chances of errors while staying compliant with recent changes in law. Let ComplianceLocal help keep your e-commerce business competitive in the fast-paced world of today. We deal with the GST hassles, and you focus on growing your online business, Simple! So, welcome aboard the journey to GST compliance with ComplyLocal.
