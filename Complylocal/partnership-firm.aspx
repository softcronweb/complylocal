<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="partnership-firm.aspx.cs" Inherits="Complylocal.partnership_firm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <section
            ...
            <div class="order-1 sm:order-2 flex flex-col lg:w-1/2  lg:pl-8">
                <h2 class="text-3xl font-bold mb-3  text-[#1c5a88]">Partnership Firm</h2>
                <ul class="list-disc text-2xl text-[#991c20] font-semibold ml-8">
                    <li>Profit and Loss Sharing</li>
                    <li>Utmost Good Faith and Honesty</li>
                    <li>Easy Formation</li>
                    <li>More Capital Aailable</li>
                    <li>Combined Workload  </li>
    ...
    <div class="bg-[#fafafa] ">
        <div class="bg-[#E5F1E3] text-[#1c5a88] px-5 sm:px-20 py-20 rounded-t-[50px] sm:rounded-t-[100px] min-h-screen flex justify-center items-center  ">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div>
                    <h3 class="text-3xl font-semibold">Partnership Firm
                    </h3>
                </div>
    ...
    <div class="bg-[#E5F1E3]">
        <section
            ...
            <div class="flex flex-col lg:w-1/2 lg:order-2 items-start">
                <h2 class="text-3xl  font-bold text-gray-900 mb-6 leading-tight">Partnership Firm
                </h2>
