<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="business-name-change.aspx.cs" Inherits="Complylocal.business_name_change" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <section
            ...
            <div class="order-1 sm:order-2 flex flex-col lg:w-1/2  lg:pl-8">
                <h2 class="text-3xl font-bold mb-3 text-[#1c5a88]">Business Name Change</h2>
    ...
    <div class="bg-[#fafafa] ">
        <div class="bg-[#E5F1E3] text-[#1c5a88] px-5 sm:px-20 py-20 rounded-t-[50px] sm:rounded-t-[100px] min-h-screen flex justify-center items-center  ">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div>
                    <h3 class="text-3xl font-semibold">Business Name Change
                    </h3>
                </div>
    ...
    <div class="bg-[#E5F1E3]">
        <section
            ...
            <div class="flex flex-col lg:w-1/2 lg:order-2 items-start">
                <h2 class="text-3xl  font-bold text-gray-900 mb-6 leading-tight">Changing Your Business Name
                </h2>
                <h3 class="text-xl font-bold text-gray-600 mb-2 ">ComplyLocal — For A Worry-Free Business Name Change!</h3>
                <p class="text-gray-600 text-lg mb-6">
                   We make rebranding easy to execute and take care of the heavy lifting for you. We ensure a seamless transition whether you are launching a brand new name or updating an existing one. We are keeping our eyes on every single detail to get things legally and leave some more room for you, so that you can concentrate only #OnYourBusiness.
                </p>
